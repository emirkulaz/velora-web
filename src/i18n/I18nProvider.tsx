...
const translations: Record<UiLanguage, Record<string, string>> = {
  tr: {
    ...
    'overview.case.inventory': 'Satışa veya üretime hazır mamul stok (adet/metre)',
    'overview.case.yarnInventory': 'İplik ve kg bazlı hammadde stoğu',
  ...
  fr: {
    ...
    'nav.yarnInventory': 'Stock de fil',
    ...
    'overview.case.inventory': 'Produits finis prêts à la vente ou à la production',
    'overview.case.yarnInventory': 'Fil et matières premières (kg)',
  ...
  en: {
    ...
    'nav.yarnInventory': 'Yarn inventory',
    'nav.production': 'Production',
    ...
    'overview.case.inventory': 'Finished goods ready for sale or production',
    'overview.case.yarnInventory': 'Yarn and kg-based raw materials',
